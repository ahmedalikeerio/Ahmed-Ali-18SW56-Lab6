...
public class Task5{
	public static void main(String[] args) {
		...
		s[0].setInfo("Ahmed Ali",19,"Qasimabad Hyderabad");
		s[1].setInfo("Waqar Ahmed",19,"Society");
		s[2].setInfo("Usama",19,"Muet hostel");
		s[3].setInfo("Imtiaz",18,"Muet hostel");
		s[4].setInfo("Uzair",18,"Jamshoro");
		s[5].setInfo("Mudassir",19,"Qasimabad Hyderabad");
		s[6].setInfo("Qudoos",19,"Qasimabad Hyderabad");
		s[7].setInfo("Altamash",19,"Muet Hostel");
